...
exports.existingUserId = exports.verifyAuthToken = exports.existingEmail = exports.uniqueEmail = exports.callerIsRootorAdmin = exports.callerIsUserOrAdmin = exports.callerIsAdmin = exports.callerIsRoot = void 0;
...
var verifyAuthToken = function (req, res, next) {
    try {
        ...
        var user = jsonwebtoken_1["default"].verify(token, process.env.TOKEN_SECRET);
        console.log("userVerifier -- verifyAuthToken -- user : ".concat(JSON.stringify(user)));
